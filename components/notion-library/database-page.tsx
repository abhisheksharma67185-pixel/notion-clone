...
// Notion-style hover preview for a Suggested template — a dark tooltip card
// positioned to the left of the hovered row, with the template's mini preview
// and its tagline underneath.
